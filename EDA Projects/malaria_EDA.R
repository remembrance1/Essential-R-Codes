...
malaria_inc <- read.csv("https://raw.githubusercontent.com/rfordatascience/tidytuesday/master/data/2018/2018-11-13/malaria_inc.csv", sep=',')
...
malaria_inc_processed %>%
  filter(country %in% sample(unique(country), 6)) %>% #randomly selects 6 unique countries
