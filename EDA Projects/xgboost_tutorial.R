...
#Translate the prediction to the original class or Species. (HOW DO I KNOW THIS??) -- cld it be based on levels in species..?
testing$prediction = ifelse(testing$prediction==0,"setosa",ifelse(testing$prediction==1,"versicolor","virginica"))

#Compute the accuracy of predictions.
confusionMatrix(as.factor(testing$prediction), as.factor(testing$Species))
